    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('contact.index') }}">Contactados</a>
            </li>
            <li class="breadcrumb-item active">Lista de contactados</li>       
        </ol>
        <!-- Example DataTables Card-->
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Contactados
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dataTable_user" width="100%" cellspacing="0">                        
                        ...
                        <tbody>
                            @if(!empty($aContacts))
                            @foreach($aContacts as $user)
                            <tr>
                                <td>{{ $user->id }}</td>
                                @if($user->type == 1)
                                    <td>No llego mi envio.</td>
                                @elseif($user->type == 2)
