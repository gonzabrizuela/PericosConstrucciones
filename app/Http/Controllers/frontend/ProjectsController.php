...
class ProjectsController extends Controller {
    ...
    public function index() {
        ...
        $aProjects=DB::select('SELECT projectss.*, pi.image as  image
        FROM projects projectss
        LEFT JOIN project_images pi ON pi.project_id = projectss.id
        ');
        ...
        ->get();
        return view('frontend/projects.index',compact('aCategories','aSubCategories','aProjects'));
    }
